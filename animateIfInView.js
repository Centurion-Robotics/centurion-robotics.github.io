...
document.addEventListener("DOMContentLoaded", () => {
	...
	// and only animate once by unobserving after first intersection.
	const observer = new IntersectionObserver((entries, observer) => {
	  entries.forEach(entry => {
		...
		// keep in-view classes persistent; do not remove to prevent re-triggering on scroll up
	  });
	});
...
/**
 * Code copied from https://www.youtube.com/watch?v=iXlkRhjnnpk
 * Edited by Microsoft Copilot
 * 2026-03-19
 */